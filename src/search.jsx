...
<h1 className="w-80" >Search Product by Name <input required onChange={(event) => setval(event.target.value)} className="shadow appearance-none border rounded w-full py-2 m-4 px-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
<button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-8 rounded " type="submit">Search</button></h1>
</div>
</form>

<div className="text-center flex flex-col justify-center mt-2  w-auto">
...
<h1 className="text-rose-600 text-2xl">{err}</h1>
